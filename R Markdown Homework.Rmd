...
Wrangle the ppt info data so that you can merge it into the auc data. Drop any data where the AUC values are missing. In the final, merged data, make the `watched` variable is coded as a factor with levels "seen" (1), "not seen" (2), "not sure" (3).  
